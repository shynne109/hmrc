 ...
 * 
 * GET https://api.company-information.service.gov.uk/transactions/{transaction_id}/insolvency/practitioners/{practitioner_id}/appointment
 */
class GetAppointmentRequest extends FilingRequest
{
