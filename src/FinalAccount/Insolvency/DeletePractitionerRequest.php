 ...
 * 
 * DELETE https://api.company-information.service.gov.uk/transactions/{transaction_id}/insolvency/practitioners/{practitioner_id}
 */
class DeletePractitionerRequest extends FilingRequest
{
