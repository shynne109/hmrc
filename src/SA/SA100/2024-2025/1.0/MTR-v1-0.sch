...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="exslt">
  ...
  <sch:ns prefix="MTR" uri="http://www.govtalk.gov.uk/taxation/SA/SA100/24-25/1"/>
    <sch:pattern id="p2">
    ...
    <sch:pattern id="p5">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA100/MTR:YourPersonalDetails/MTR:DateOfBirth">
        <sch:assert test="(round(date:seconds(normalize-space((.))) div 86400) &lt;= round(date:seconds(normalize-space(&quot;2025-04-05&quot;)) div 86400))" id="a_ITF1-TAXPAYER-DATE-OF-BIRTH.0" diagnostics="errorCode.ITF1-TAXPAYER-DATE-OF-BIRTH.0 transactional.ITF1-TAXPAYER-DATE-OF-BIRTH.0 transactional.en.ITF1-TAXPAYER-DATE-OF-BIRTH.0 ">[YPD1] must be on or before the end of the return year.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p6">
    ...
    <sch:pattern id="p36">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA100/MTR:MarriageAllowance/MTR:DateOfMarriageOrCivilPartnership">
        <sch:assert test="(round(date:seconds(normalize-space(.)) div 86400) &lt;= round(date:seconds(normalize-space(&quot;2025-04-05&quot;)) div 86400))" id="a_ITF-MA-PARTNERSHIP-DATE.0" diagnostics="errorCode.ITF-MA-PARTNERSHIP-DATE.0 transactional.ITF-MA-PARTNERSHIP-DATE.0 transactional.en.ITF-MA-PARTNERSHIP-DATE.0 ">[MAT5] is valid only if this is on or before [5 April 2025]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p38">
...
venture capital trust share subscriptions is valid if and only if this does not exceed [£200,000]</sch:assert>
    ...
    <sch:pattern id="p54">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA101/MTR:OtherTaxReliefs/MTR:MaintenanceOrAlimonyPayments">
        <sch:assert test=". &lt;= 4280" id="a_ITF-ALIMONY-NEW-RULES-RELIEF.0" diagnostics="errorCode.ITF-ALIMONY-NEW-RULES-RELIEF.0 transactional.ITF-ALIMONY-NEW-RULES-RELIEF.0 transactional.en.ITF-ALIMONY-NEW-RULES-RELIEF.0 ">[AOR7] is valid only if this does not exceed [£4,280]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p55">
    ...
    <sch:pattern id="p80">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA102M/MTR:Income/MTR:TotalIncomeAsMinisterOfReligion">
        <sch:assert test="(math:abs((.) - ((sum(../MTR:SalaryOrStipend) + sum(../MTR:FeesAndOfferings) + sum(../MTR:PensionContributionPaymentFromHMRC) + sum(../MTR:VicarageManseExpenses) + sum(../MTR:PersonalExpensesEtcPaid) + sum(../MTR:ExcessMileageAllowanceEtc) + sum(../MTR:RoundSumExpensesAndRentAllowances) + sum(../MTR:OtherIncomeFromPost)))) &lt; 0.001)" id="a_MOR4-MOR-INCOME-TOT.0" diagnostics="errorCode.MOR4-MOR-INCOME-TOT.0 transactional.MOR4-MOR-INCOME-TOT.0 transactional.en.MOR4-MOR-INCOME-TOT.0 ">[MOR12] is valid only if this equals ( the sum of [MOR2], [MOR4], [MOR4.1], [MOR5], [MOR6], [MOR7], [MOR8], and [MOR10] )</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p81">
...
taxable income minus expenses is valid if and only if this equals ( ( [MOR20] plus [MOR36] ) minus ( [MOR26] plus [MOR35] ) )</sch:assert>
    ...
    <sch:pattern id="p75">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA102M">
        ...
        <sch:assert test="not(MTR:Income/MTR:PensionContributionPaymentFromHMRC) or MTR:Income/MTR:TotalIncomeAsMinisterOfReligion" id="a_SA102M.7" diagnostics="errorCode.SA102M.7 transactional.SA102M.7 transactional.en.SA102M.7 ">[MOR12] should be present if [MOR4.1] is present</sch:assert>
...
total business assets is valid if and only if this equals ( The sum of [FSE83], [FSE84], [FSE85], [FSE86], [FSE87], [FSE88], and [FSE89] )</sch:assert>
    ...
    <sch:pattern id="p156">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA103F/MTR:NICs/MTR:Class2NICamount">
        <sch:assert test=". &lt;= 217.30" id="a_SLF-CLASS-2-NIC-AMOUNT.0" diagnostics="errorCode.SLF-CLASS-2-NIC-AMOUNT.0 transactional.SLF-CLASS-2-NIC-AMOUNT.0 transactional.en.SLF-CLASS-2-NIC-AMOUNT.0 ">[FSECL2] is valid only if this does not exceed [£217.30]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p155">
    ...
    <sch:pattern id="p160">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA103S/MTR:BusinessIncome/MTR:Turnover">
        ...
        <sch:assert test="not(../../MTR:BusinessDetails/MTR:DateBusinessStarted) or ../../MTR:BusinessDetails/MTR:DateBusinessCeased
                or
              ((.) - 90000 * ((round((date:seconds(normalize-space(&apos;2025-04-05&apos;)) - date:seconds(normalize-space(../../MTR:BusinessDetails/MTR:DateBusinessStarted))) div 86400 ) + 1) div (round( date:seconds(date:difference(&apos;2024-04-06&apos;, &apos;2025-04-05&apos;)) div 86400 ) + 1))) &lt; -0.00000001" id="a_SSE-BUSINESS-SALES-TURNOVER.1" diagnostics="errorCode.SSE-BUSINESS-SALES-TURNOVER.1 transactional.SSE-BUSINESS-SALES-TURNOVER.1 transactional.en.SSE-BUSINESS-SALES-TURNOVER.1 ">If [SSE5] present but [SSE6] is absent, amount must be below ([£90,000] x no of days / (365 or 366) ) where no of days = no of days from ( [SSE5]  to [5 April 2025] inclusive )</sch:assert>
        <sch:assert test="../../MTR:BusinessDetails/MTR:DateBusinessStarted or not(../../MTR:BusinessDetails/MTR:DateBusinessCeased)
                or
              ((.) - 90000 * ((round((date:seconds(normalize-space(../../MTR:BusinessDetails/MTR:DateBusinessCeased)) - date:seconds(normalize-space(&apos;2024-04-06&apos;))) div 86400 ) + 1) div (round( date:seconds(date:difference(&apos;2024-04-06&apos;, &apos;2025-04-05&apos;)) div 86400 ) + 1))) &lt; -0.00000001" id="a_SSE-BUSINESS-SALES-TURNOVER.2" diagnostics="errorCode.SSE-BUSINESS-SALES-TURNOVER.2 transactional.SSE-BUSINESS-SALES-TURNOVER.2 transactional.en.SSE-BUSINESS-SALES-TURNOVER.2 ">If [SSE6] is present but [SSE5] is absent, amount must be below ( [£90,000] x no of days / (365 or 366) ) where no of days = no of days from ( [6 April 2024] to [SSE6] inclusive )</sch:assert>
        <sch:assert test="not(../../MTR:BusinessDetails/MTR:DateBusinessStarted) or not(../../MTR:BusinessDetails/MTR:DateBusinessCeased)
                or
              (((.) -  (90000 * ((round((date:seconds(normalize-space(../../MTR:BusinessDetails/MTR:DateBusinessCeased)) - date:seconds(normalize-space(../../MTR:BusinessDetails/MTR:DateBusinessStarted))) div 86400 ) + 1) div (round( date:seconds(date:difference(&apos;2024-04-06&apos;, &apos;2025-04-05&apos;)) div 86400 ) + 1)))) &lt; -0.00000001)" id="a_SSE-BUSINESS-SALES-TURNOVER.3" diagnostics="errorCode.SSE-BUSINESS-SALES-TURNOVER.3 transactional.SSE-BUSINESS-SALES-TURNOVER.3 transactional.en.SSE-BUSINESS-SALES-TURNOVER.3 ">If [SSE5] and [SSE6] are both present, amount must be below ( [£90,000] x no of days / (365 or 366) ) where the no of days = no of days from [SSE5] to [SSE6] inclusive</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p161">
...
(
    ...
    <sch:pattern id="p186">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA103S/MTR:ProfitsLossesNICsAndCIS/MTR:Class2NICamount">
        <sch:assert test=". &lt;= 217.30" id="a_SSE-CLASS-2-NIC-AMOUNT.0" diagnostics="errorCode.SSE-CLASS-2-NIC-AMOUNT.0 transactional.SSE-CLASS-2-NIC-AMOUNT.0 transactional.en.SSE-CLASS-2-NIC-AMOUNT.0 ">[SSECL2] is valid only if this does not exceed [£217.30]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p157">
...
(math:abs((.) - (sum(../../MTR:ProfitAmount) - ( sum(../MTR:ForeignTaxClaimedAsDeduction) + sum(../MTR:UnusedLossesBroughtForward) ))) &lt; 0.001)" id="a_LUW3-TOT-LLOYDS-TAXABLE-PROFIT.0" diagnostics="errorCode.LUW3-TOT-LLOYDS-TAXABLE-PROFIT.0 transactional.LUW3-TOT-LLOYDS-TAXABLE-PROFIT.0 transactional.en.LUW3-TOT-LLOYDS-TAXABLE-PROFIT.0 ">If the sum of [LUN41] - ( [LUN50] + [LUN51] ) is positive or zero then [LUN52] must equal that sum</sch:assert>
    ...
    <sch:pattern id="p224">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA103L/MTR:NICs/MTR:Class2NICamount">
        <sch:assert test=". &lt;= 217.30" id="a_LUW-CLASS-2-NIC-AMOUNT.0" diagnostics="errorCode.LUW-CLASS-2-NIC-AMOUNT.0 transactional.LUW-CLASS-2-NIC-AMOUNT.0 transactional.en.LUW-CLASS-2-NIC-AMOUNT.0 ">[LUNCL2] is valid only if this does not exceed [£217.30]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p222">
    ...
    <sch:pattern id="p239">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA104F/MTR:NICs/MTR:Class2NICamount">
        <sch:assert test=". &lt;= 217.30" id="a_PTR-CLASS-2-NIC-AMOUNT.0" diagnostics="errorCode.PTR-CLASS-2-NIC-AMOUNT.0 transactional.PTR-CLASS-2-NIC-AMOUNT.0 transactional.en.PTR-CLASS-2-NIC-AMOUNT.0 ">[FPSCL2] is valid only if this does not exceed [£217.30]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p237">
    ...
    <sch:pattern id="p255">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA104F/MTR:ShareOfUntaxedIncome/MTR:TotalUntaxedIncomeShare">
        <sch:assert test="(math:abs((.) - ((sum(../MTR:UKPropertyIncome/MTR:TaxableProfitsAfterAdjustmentAndLosses) + sum(../MTR:TaxableFHLProfit) + sum(../MTR:OtherUntaxedUKIncome/MTR:TaxableProfit) + sum(../MTR:OffshoreFundsIncome/MTR:TaxableIncomeAfterAdjustmentAndForeignTax) + sum(../MTR:OtherUntaxedForeignIncome/MTR:TaxableProfit)))) &lt; 0.001)" id="a_PTR-TOTAL-UNTAXED-INCOME.0" diagnostics="errorCode.PTR-TOTAL-UNTAXED-INCOME.0 transactional.PTR-TOTAL-UNTAXED-INCOME.0 transactional.en.PTR-TOTAL-UNTAXED-INCOME.0 ">[FPS67] is valid only if this equals ( The sum of [FPS41], [FPS44], [FPS48], [FPS55], and [FPS60] )</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p256">
...
share of total taxed and untaxed income should be present if ( ( The sum of [FPS20], [FPS67], and [FPS74] ) minus [FPS75] ) exceeds 0</sch:assert>
        ...
        <sch:assert test="not((((sum(MTR:ShareOfUntaxedIncome/MTR:UKPropertyIncome/MTR:TaxableProfitsAfterAdjustmentAndLosses) + sum(MTR:ShareOfUntaxedIncome/MTR:TaxableFHLProfit) + sum(MTR:ShareOfUntaxedIncome/MTR:OtherUntaxedUKIncome/MTR:TaxableProfit) + sum(MTR:ShareOfUntaxedIncome/MTR:OffshoreFundsIncome/MTR:TaxableIncomeAfterAdjustmentAndForeignTax) + sum(MTR:ShareOfUntaxedIncome/MTR:OtherUntaxedForeignIncome/MTR:TaxableProfit))) - (0) &gt;= 0.001)) or MTR:ShareOfUntaxedIncome/MTR:TotalUntaxedIncomeShare" id="a_SA104F.0" diagnostics="errorCode.SA104F.0 transactional.SA104F.0 transactional.en.SA104F.0 ">[FPS67] should be present if ( The sum of [FPS41], [FPS44], [FPS48], [FPS55], and [FPS60] ) exceeds 0</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p262">
    ...
    <sch:pattern id="p274">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA104S/MTR:NICs/MTR:Class2NICamount">
        <sch:assert test=". &lt;= 217.30" id="a_SPS-CLASS-2-NIC-AMOUNT.0" diagnostics="errorCode.SPS-CLASS-2-NIC-AMOUNT.0 transactional.SPS-CLASS-2-NIC-AMOUNT.0 transactional.en.SPS-CLASS-2-NIC-AMOUNT.0 ">[SPSCL2] is valid only if this does not exceed [£217.30]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p272">
    ...
    <sch:pattern id="p278">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:FurnishedHolidayLettingsExpenses">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-FURNISHED-LETS-EXPS-AMO.0" diagnostics="errorCode.UKL-FURNISHED-LETS-EXPS-AMO.0 transactional.UKL-FURNISHED-LETS-EXPS-AMO.0 transactional.en.UKL-FURNISHED-LETS-EXPS-AMO.0 ">[PRO6] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p279">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:FurnishedHolidayLettingsInterestEtcCosts">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-LETTINGS-FINANCE-CHARGES.0" diagnostics="errorCode.UKL-LETTINGS-FINANCE-CHARGES.0 transactional.UKL-LETTINGS-FINANCE-CHARGES.0 transactional.en.UKL-LETTINGS-FINANCE-CHARGES.0 ">[PRO7] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p280">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:FurnishedHolidayLettingsManagementEtcFees">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-LETTINGS-LEGAL-CHARGES.0" diagnostics="errorCode.UKL-LETTINGS-LEGAL-CHARGES.0 transactional.UKL-LETTINGS-LEGAL-CHARGES.0 transactional.en.UKL-LETTINGS-LEGAL-CHARGES.0 ">[PRO8] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p281">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:FurnishedHolidayLettingsOtherExpenses">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-LETTINGS-OTHER-DEDUCTIONS.0" diagnostics="errorCode.UKL-LETTINGS-OTHER-DEDUCTIONS.0 transactional.UKL-LETTINGS-OTHER-DEDUCTIONS.0 transactional.en.UKL-LETTINGS-OTHER-DEDUCTIONS.0 ">[PRO9] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p282">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PrivateUseAdjustment">
        ...
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-LETTINGS-PRIVATE-USE-ADJ.0" diagnostics="errorCode.UKL-LETTINGS-PRIVATE-USE-ADJ.0 transactional.UKL-LETTINGS-PRIVATE-USE-ADJ.0 transactional.en.UKL-LETTINGS-PRIVATE-USE-ADJ.0 ">[PRO10] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p283">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:ElectricChargePointAllowance">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-ECP-ALLCE.0" diagnostics="errorCode.UKL-ECP-ALLCE.0 transactional.UKL-ECP-ALLCE.0 transactional.en.UKL-ECP-ALLCE.0 ">[PRO11.1] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p284">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:ZeroEmissionCarAllowance">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-ZERO-EMISSION-CAR-ALLCE.0" diagnostics="errorCode.UKL-ZERO-EMISSION-CAR-ALLCE.0 transactional.UKL-ZERO-EMISSION-CAR-ALLCE.0 transactional.en.UKL-ZERO-EMISSION-CAR-ALLCE.0 ">[PRO11.2] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p285">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:CapitalAllowances">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-LETTINGS-CAPITAL-ALLCE.0" diagnostics="errorCode.UKL-LETTINGS-CAPITAL-ALLCE.0 transactional.UKL-LETTINGS-CAPITAL-ALLCE.0 transactional.en.UKL-LETTINGS-CAPITAL-ALLCE.0 ">[PRO12] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p286">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:AdjustedProfitForTheYear">
        <sch:assert test="(math:abs((.) - ((sum(../MTR:FurnishedHolidayLettingsIncome) 
			    ...
			    + sum(../MTR:CapitalAllowances)))) &lt; 0.001)" id="a_UKL-FURNISHED-LETS-PROFIT-AMT.1" diagnostics="errorCode.UKL-FURNISHED-LETS-PROFIT-AMT.1 transactional.UKL-FURNISHED-LETS-PROFIT-AMT.1 transactional.en.UKL-FURNISHED-LETS-PROFIT-AMT.1 ">[PRO13] must equal the sum of [PRO5] + [PRO10] + [PRO11] minus sum of ([PRO5.1] + [PRO6] + [PRO7] + [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12])</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p287">
    ...
    <sch:pattern id="p289">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings/MTR:LossForYear">
        ...
        <sch:assert test="(math:abs(((.)) - (sum(../MTR:FurnishedHolidayLettingsExpenses) 
			    + sum(../MTR:FurnishedHolidayLettingsInterestEtcCosts) 
			    + sum(../MTR:FurnishedHolidayLettingsManagementEtcFees) 
			    + sum(../MTR:FurnishedHolidayLettingsOtherExpenses) 
			    + sum(../MTR:ElectricChargePointAllowance)
			    ...
			    + sum(../MTR:PrivateUseAdjustment) 
			    + sum(../MTR:BalancingCharges)))) &lt; 0.001)" id="a_UKL-PRO-HOLIDAY-LETTINGS.1" diagnostics="errorCode.UKL-PRO-HOLIDAY-LETTINGS.1 transactional.UKL-PRO-HOLIDAY-LETTINGS.1 transactional.en.UKL-PRO-HOLIDAY-LETTINGS.1 ">[PRO16] must equal [PRO6] + [PRO7] + [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12] minus ([PRO5] + [PRO10] + [PRO11]).</sch:assert>
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_UKL-FURNISHED-LETS-LOSS-AMT.1" diagnostics="errorCode.UKL-FURNISHED-LETS-LOSS-AMT.1 transactional.UKL-FURNISHED-LETS-LOSS-AMT.1 transactional.en.UKL-FURNISHED-LETS-LOSS-AMT.1 ">[PRO16] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p276">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105/MTR:FurnishedHolidayLettings">
        <sch:assert test="MTR:AdjustedProfitForTheYear 
            or not(((sum(MTR:FurnishedHolidayLettingsIncome) 
            + sum(MTR:PrivateUseAdjustment) 
            + sum(MTR:BalancingCharges) 
            - 
             (sum(MTR:PropertyIncomeAllowance) 
	    ...
	    + sum(MTR:ElectricChargePointAllowance)
	    + sum(MTR:ZeroEmissionCarAllowance)
            + sum(MTR:CapitalAllowances))) - (0) &gt;= 0.001))" id="a_UKL-PRO-HOLIDAY-LETTINGS.0" diagnostics="errorCode.UKL-PRO-HOLIDAY-LETTINGS.0 transactional.UKL-PRO-HOLIDAY-LETTINGS.0 transactional.en.UKL-PRO-HOLIDAY-LETTINGS.0 ">[PRO13] is mandatory if the sum of ([PRO5] + [PRO10] + [PRO11]) minus the sum of ([PRO5.1] + [PRO6] + [PRO7] +  [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12]) is more than zero.</sch:assert>
		...
		+ sum(MTR:ElectricChargePointAllowance)
            ...
            -  (  sum(MTR:FurnishedHolidayLettingsIncome)
              ...
              or 
            MTR:LossForYear" id="a_UKL-PRO-HOLIDAY-LETTINGS.4" diagnostics="errorCode.UKL-PRO-HOLIDAY-LETTINGS.4 transactional.UKL-PRO-HOLIDAY-LETTINGS.4 transactional.en.UKL-PRO-HOLIDAY-LETTINGS.4 ">[PRO16] should be present if ( ( The sum of [PRO6], [PRO7], [PRO8], [PRO9], [PRO11.1], [PRO11.2] and [PRO12] ) minus ( The sum of [PRO5], [PRO10], and [PRO11] ) ) exceeds 0</sch:assert>
        <sch:assert test="MTR:InEEA
            ...
            or
              boolean(../MTR:PropertyIncomeAndExpenses/MTR:TraditionalAccounting) = boolean(MTR:TraditionalAccounting)" id="a_UKL-PRO-HOLIDAY-LETTINGS.5" diagnostics="errorCode.UKL-PRO-HOLIDAY-LETTINGS.5 transactional.UKL-PRO-HOLIDAY-LETTINGS.5 transactional.en.UKL-PRO-HOLIDAY-LETTINGS.5 ">If there is an occurrence of [PRO5-19] without [PRO18], and any box in [SA105] after the end of [PRO5-19] has been submitted, then [PRO20.2] and the [PRO5.2] from that occurrence must either both be submitted or both be absent.</sch:assert>
    ...
    <sch:pattern id="p275">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA105">
        ...
        <sch:assert test="MTR:PropertyIncomeAndExpenses/MTR:TraditionalAccounting
	    or
            ((sum(MTR:FurnishedHolidayLettings/MTR:FurnishedHolidayLettingsIncome[not(../MTR:InEEA) and not(../MTR:TraditionalAccounting)])
               +
	       sum(MTR:FurnishedHolidayLettings/MTR:BalancingCharges[not(../MTR:InEEA) and not(../MTR:TraditionalAccounting)])
               + sum(MTR:PropertyIncomeAndExpenses/MTR:TotalRentsAndOtherIncomeFromProperty) + sum(MTR:PropertyIncomeAndExpenses/MTR:PremiumsForGrantOfALease) + sum(MTR:PropertyIncomeAndExpenses/MTR:ReversePremiumsAndInducements) + sum(MTR:TaxableProfitOrLoss/MTR:BalancingCharges)) - (150000) &lt; 0.001)" id="a_SA105.6" diagnostics="errorCode.SA105.6 transactional.SA105.6 transactional.en.SA105.6 ">Total of all instances of ( [PRO5] and [PRO11] where (both [PRO5.2] and [PRO18] are absent in that instance ) plus the total of all instances of ( [PRO20], [PRO22], [PRO23] and [PRO31] ) must not exceed [£150,000] if [PRO20.2] is absent.</sch:assert>
...
( 
  ...
  (math:abs((sum(MTR:TaxableAmountOnInterestAndOtherSavings)) - (sum(MTR:IncomeBeforeTax))) &lt; 0.001) 
    ...
    <sch:pattern id="p330">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:RemittedForeignSavings/MTR:IncomeSource/MTR:IncomeBeforeTax">
        <sch:assert test="../MTR:TaxableAmount" id="a_FIG-REM-SAV-GROSS-AMT.1" diagnostics="errorCode.FIG-REM-SAV-GROSS-AMT.1 transactional.FIG-REM-SAV-GROSS-AMT.1 transactional.en.FIG-REM-SAV-GROSS-AMT.1 ">[FOR7.2F (pseudo)] must be present if [FOR7.2B] is present</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p331">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:RemittedForeignSavings/MTR:IncomeSource/MTR:ForeignTax">
        <sch:assert test=". &lt;= sum(../MTR:IncomeBeforeTax)" id="a_FIG-REM-SAV-FOREIGN-TAX-AMT.1" diagnostics="errorCode.FIG-REM-SAV-FOREIGN-TAX-AMT.1 transactional.FIG-REM-SAV-FOREIGN-TAX-AMT.1 transactional.en.FIG-REM-SAV-FOREIGN-TAX-AMT.1 ">[FOR7.2C] should not exceed [FOR7.2B]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p332">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:RemittedForeignSavings/MTR:IncomeSource/MTR:SpecialWithholdingTax">
        <sch:assert test=". &lt;= sum(../MTR:IncomeBeforeTax)" id="a_FIG-REM-SAV-TAX-ITEM-AMT.1" diagnostics="errorCode.FIG-REM-SAV-TAX-ITEM-AMT.1 transactional.FIG-REM-SAV-TAX-ITEM-AMT.1 transactional.en.FIG-REM-SAV-TAX-ITEM-AMT.1 ">[FOR7.2D (pseudo)] should not exceed [FOR7.2B]</sch:assert>
        <sch:assert test="../../MTR:Totals/MTR:SWTOrUKTax" id="a_FIG-REM-SAV-TAX-ITEM-AMT.2" diagnostics="errorCode.FIG-REM-SAV-TAX-ITEM-AMT.2 transactional.FIG-REM-SAV-TAX-ITEM-AMT.2 transactional.en.FIG-REM-SAV-TAX-ITEM-AMT.2 ">[FOR7.1] must be present if [FOR7.2D (pseudo)] is present</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p333">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:RemittedForeignSavings/MTR:IncomeSource/MTR:TaxableAmount">
        <sch:assert test="../../MTR:Totals/MTR:TaxableAmount" id="a_FIG-REM-SAV-UK-CHARGEABLE-AMO.1" diagnostics="errorCode.FIG-REM-SAV-UK-CHARGEABLE-AMO.1 transactional.FIG-REM-SAV-UK-CHARGEABLE-AMO.1 transactional.en.FIG-REM-SAV-UK-CHARGEABLE-AMO.1 ">[FOR7.2] must be present if [FOR7.2F (pseudo)] is present</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p329">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:RemittedForeignSavings/MTR:IncomeSource">
        <sch:assert test="not(MTR:ClaimToFTCR) or sum(MTR:TaxableAmount) = sum(MTR:IncomeBeforeTax)" id="a_FIG-REMITTED-FORG-SAVINGS.0" diagnostics="errorCode.FIG-REMITTED-FORG-SAVINGS.0 transactional.FIG-REMITTED-FORG-SAVINGS.0 transactional.en.FIG-REMITTED-FORG-SAVINGS.0 ">[FOR7.2F (pseudo)] must be equal to [FOR7.2B] if [FOR7.2E] is present</sch:assert>
        <sch:assert test="MTR:ClaimToFTCR or (math:abs((sum(MTR:TaxableAmount)) - (sum(MTR:IncomeBeforeTax) - sum(MTR:ForeignTax))) &lt; 0.001)" id="a_FIG-REMITTED-FORG-SAVINGS.1" diagnostics="errorCode.FIG-REMITTED-FORG-SAVINGS.1 transactional.FIG-REMITTED-FORG-SAVINGS.1 transactional.en.FIG-REMITTED-FORG-SAVINGS.1 ">[FOR7.2F (pseudo)] must be equal to [FOR7.2B] - [FOR7.2C] if [FOR7.2E] is absent</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p334">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:RemittedForeignSavings/MTR:Totals/MTR:SWTOrUKTax">
    ...
    <sch:pattern id="p335">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:RemittedForeignSavings/MTR:Totals/MTR:TaxableAmount">
  ...
  (math:abs((sum(MTR:TaxableAmountOnInterestAndOtherSavings)) - (sum(MTR:IncomeBeforeTax))) &lt; 0.001) 
    ...
    <sch:pattern id="p374">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:ZeroEmissionGoodsVehicleAllowance">
        ...
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_FIG-ZERO-EMISSION-GV-ALLCE.0" diagnostics="errorCode.FIG-ZERO-EMISSION-GV-ALLCE.0 transactional.FIG-ZERO-EMISSION-GV-ALLCE.0 transactional.en.FIG-ZERO-EMISSION-GV-ALLCE.0 ">[FOR22] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p375">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:TheStructuresAndBuildingsAllowance">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_FIG-SB-ALLCE.0" diagnostics="errorCode.FIG-SB-ALLCE.0 transactional.FIG-SB-ALLCE.0 transactional.en.FIG-SB-ALLCE.0 ">[FOR22.1] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
    ...
    <sch:pattern id="p376">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:ElectricChargePointAllowance">
        <sch:assert test="not(../../../MTR:SA105/MTR:FurnishedHolidayLettings/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA105/MTR:PropertyIncomeAndExpenses/MTR:PropertyIncomeAllowance) and
		      not(../../../MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:PropertyIncomeAllowance)" id="a_FIG-ECP-ALLCE.0" diagnostics="errorCode.FIG-ECP-ALLCE.0 transactional.FIG-ECP-ALLCE.0 transactional.en.FIG-ECP-ALLCE.0 ">[FOR22.2] should not be present if any instance of [PRO5.1] or [PRO20.1] or [FOR14.1] is present.</sch:assert>
    ...
    <sch:pattern id="p378">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA106/MTR:OverseasLandAndPropertyIncomeDetails/MTR:AdjustedProfitOrLossForTheYear">
        ...
        <sch:assert test="(math:abs((.) - (((sum(../MTR:NetProfitOrLoss) 
		      ...
		      + sum(../MTR:TheStructuresAndBuildingsAllowance) 
		      + sum(../MTR:ElectricChargePointAllowance) 
		      + sum(../MTR:CostsOfReplacingDomesticItems))))) &lt; 0.001)" id="a_FIG-PPTY-ADJUSTD-PROF-LOSS-AMT.0" diagnostics="errorCode.FIG-PPTY-ADJUSTD-PROF-LOSS-AMT.0 transactional.FIG-PPTY-ADJUSTD-PROF-LOSS-AMT.0 transactional.en.FIG-PPTY-ADJUSTD-PROF-LOSS-AMT.0 ">[FOR24] is valid only if this equals ( ( The sum of [FOR18], [FOR19], and [FOR20] ) minus ( The sum of [FOR14.1], [FOR21], [FOR21.1], [FOR22], [FOR22.1], [FOR22.2], and [FOR23] ) )</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p379">
...
( ((sum(../MTR:TotalAdjustedProfitOrLoss) - sum(../MTR:LossBroughtForward)) - (0) &lt;= -0.001) and (math:abs((.) - (0)) &lt; 0.001) )" id="a_FIG4-LET-PPTY-TAXABLE-TOT.1" diagnostics="errorCode.FIG4-LET-PPTY-TAXABLE-TOT.1 transactional.FIG4-LET-PPTY-TAXABLE-TOT.1 transactional.en.FIG4-LET-PPTY-TAXABLE-TOT.1 ">If [FOR25] minus [FOR26] is positive or zero then [FOR27] = [FOR25] minus [FOR26] else [FOR27] must be absent or zero</sch:assert>
    ...
    <sch:pattern id="p392">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA108/MTR:ResidentialPropertyAndCarriedInterest">
        <sch:assert test="(.)/*" id="a_RIM-CGT-PROPERTY-RES.1" diagnostics="errorCode.RIM-CGT-PROPERTY-RES.1 transactional.RIM-CGT-PROPERTY-RES.1 transactional.en.RIM-CGT-PROPERTY-RES.1 ">[CGT3-13B] should contain at least one element.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p403">
    ...
    <sch:pattern id="p436">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA108/MTR:LossesAndAdjustments/MTR:GainsQualifyingForInvestorsRelief">
        <sch:assert test=". &lt;= 10000000" id="a_CAP-INVESTORS-RELIEF-AMT.0" diagnostics="errorCode.CAP-INVESTORS-RELIEF-AMT.0 transactional.CAP-INVESTORS-RELIEF-AMT.0 transactional.en.CAP-INVESTORS-RELIEF-AMT.0 ">[CGT49] should not exceed [£10,000,000]</sch:assert>
    ...
    <sch:pattern id="p457">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA109/MTR:RemittanceBasis/MTR:DeemedUKdomicileAndPreviouslyClaimedRemitanceBasis">
        <sch:assert test="not(../MTR:Remittancebasisclaim) or ../MTR:UnremitedIncomeAndGainsUnremittedIncomeAndGainsUnder2000" id="a_UK-DOM-PREVIOUS-REMITTANCE.0" diagnostics="errorCode.UK-DOM-PREVIOUS-REMITTANCE.0 transactional.UK-DOM-PREVIOUS-REMITTANCE.0 transactional.en.UK-DOM-PREVIOUS-REMITTANCE.0 ">If [NRD30] is present then [NRD28] must not be present unless [NRD29] is present.</sch:assert>
    ...
    <sch:pattern id="p461">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA109/MTR:RemittanceBasis/MTR:QAHCincomeOrGains">
        <sch:assert test="../MTR:Remittancebasisclaim" id="a_DOM-QAHC-DEEMED-SIG.0" diagnostics="errorCode.DOM-QAHC-DEEMED-SIG.0 transactional.DOM-QAHC-DEEMED-SIG.0 transactional.en.DOM-QAHC-DEEMED-SIG.0 ">If [NRD39.1] is present [NRD28] should be present</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p444">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA109">
        ...
        <sch:assert test="not((MTR:Domicile/MTR:ConditionA or MTR:Domicile/MTR:ConditionB) and MTR:RemittanceBasis/MTR:Remittancebasisclaim) or MTR:RemittanceBasis/MTR:UnremitedIncomeAndGainsUnremittedIncomeAndGainsUnder2000" id="a_SA109.1" diagnostics="errorCode.SA109.1 transactional.SA109.1 transactional.en.SA109.1 ">[NRD29] should be present if at least one of [NRD23.1] and [NRD23.2] are present and [NRD28] is present.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p462">
    ...
    <sch:pattern id="p464">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA110/MTR:SelfAssessment/MTR:Class2NICsDue">
        <sch:assert test=". &lt;= 217.30" id="a_ITF-SELF-CALC-CLASS2-NIC-TOTAL.0" diagnostics="errorCode.ITF-SELF-CALC-CLASS2-NIC-TOTAL.0 transactional.ITF-SELF-CALC-CLASS2-NIC-TOTAL.0 transactional.en.ITF-SELF-CALC-CLASS2-NIC-TOTAL.0 ">[CAL4.1] is valid only if this does not exceed [£217.30]</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p465">
    ...
    <sch:pattern id="p467">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA110/MTR:SurplusAllowances/MTR:SurplusBlindPersonsAllowance">
        <sch:assert test="(.) &lt;= 3070" id="a_ITF-BPA-AMOUNT.1" diagnostics="errorCode.ITF-BPA-AMOUNT.1 transactional.ITF-BPA-AMOUNT.1 transactional.en.ITF-BPA-AMOUNT.1 ">[CAL12] must not exceed [£3,070] for the year.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p468">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR/MTR:SA110/MTR:SurplusAllowances/MTR:SurplusMarriedCouplesAllowance">
        <sch:assert test="(.) &lt;= 11080" id="a_ITF4-MCA-AMOUNT.0" diagnostics="errorCode.ITF4-MCA-AMOUNT.0 transactional.ITF4-MCA-AMOUNT.0 transactional.en.ITF4-MCA-AMOUNT.0 ">[CAL13] must not exceed [£11,080] for the year.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p469">
    ...
    <sch:pattern id="p3">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/MTR:IRenvelope/MTR:MTR">
        ...
        <sch:assert test="((sum(MTR:SA103S/MTR:ProfitsLossesNICsAndCIS/MTR:Class2NICamount)
            ...
            + sum(MTR:SA104S/MTR:NICs/MTR:Class2NICamount)) - (217.30) &lt; 0.001)" id="a_X-SCHEDULE.5" diagnostics="errorCode.X-SCHEDULE.5 transactional.X-SCHEDULE.5 transactional.en.X-SCHEDULE.5 ">(Total all instances [SSECL2] + [FSECL2] + [FPSCL2] + [SPSCL2]) + [LUNCL2] must be less than or equal to [£217.30].</sch:assert>
        <sch:assert test="not(
        ...
        or
          ((sum(MTR:SA103S/MTR:ProfitsLossesNICsAndCIS/MTR:TotalTaxableBusinessProfits)
            ...
            )) - (6725) &lt;= -0.001)" id="a_X-SCHEDULE.6" diagnostics="errorCode.X-SCHEDULE.6 transactional.X-SCHEDULE.6 transactional.en.X-SCHEDULE.6 ">Where any of [SSE36], [FSE100], [LUN63], [SPS25] or [FPS25] are present then the sum of all instances [SSE31] + sum of all instances [FSE76] + [LUN52] + sum of all instances [SPS20] + sum of all instances [FPS20] - (sum of all instances [FSE102] + [LUN65] + sum of all instances [SPS27] + sum of all instances [FPS27]) should be less than [£6,725]</sch:assert>
  ...
  <sch:diagnostics>
    ...
    <sch:diagnostic id="transactional.X-SCHEDULE.5">The total of all instances [SSECL2] + [FSECL2] + [FPSCL2] + [SPSCL2]) + [LUNCL2] must be less than or equal to [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.X-SCHEDULE.5">The total of all instances [SSECL2] + [FSECL2] + [FPSCL2] + [SPSCL2]) + [LUNCL2] must be less than or equal to [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.X-SCHEDULE.6">8374</sch:diagnostic>
    <sch:diagnostic id="transactional.X-SCHEDULE.6">As there is an entry in any of [SSE36], [FSE100], [LUN63], [SPS25] or [FPS25] the sum of all instances [SSE31] + sum of all instances [FSE76] + [LUN52] + sum of all instances [SPS20] + sum of all instances [FPS20] - (sum of all instances [FSE102] + [LUN65] + sum of all instances [SPS27] + sum of all instances [FPS27]) should be less than [£6,725]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.X-SCHEDULE.6">As there is an entry in any of [SSE36], [FSE100], [LUN63], [SPS25] or [FPS25] the sum of all instances [SSE31] + sum of all instances [FSE76] + [LUN52] + sum of all instances [SPS20] + sum of all instances [FPS20] - (sum of all instances [FSE102] + [LUN65] + sum of all instances [SPS27] + sum of all instances [FPS27]) should be less than [£6,725]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.ITF-MA-PARTNERSHIP-DATE.0">The entry in [MAT5] must be on or before [5 April 2025]</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.ITF-MA-PARTNERSHIP-DATE.0">The entry in [MAT5] must be on or before [5 April 2025]</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.ITF-ALIMONY-NEW-RULES-RELIEF.0">The amount in box [AOR7] exceeds the upper limit for relief of  [£4,280]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.ITF-ALIMONY-NEW-RULES-RELIEF.0">The amount in box [AOR7] exceeds the upper limit for relief of  [£4,280]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="errorCode.SA102M.7">8637</sch:diagnostic>
    <sch:diagnostic id="transactional.SA102M.7">[MOR12] must be present if [MOR4.1] is present</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SA102M.7">[MOR12] must be present if [MOR4.1] is present</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.MOR4-MOR-INCOME-TOT.0">The amount in box [MOR12] must equal ( the sum of [MOR2], [MOR4], [MOR4.1], [MOR5], [MOR6], [MOR7], [MOR8], and [MOR10] ). Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.MOR4-MOR-INCOME-TOT.0">The amount in box [MOR12] must equal ( the sum of [MOR2], [MOR4], [MOR4.1], [MOR5], [MOR6], [MOR7], [MOR8], and [MOR10] ). Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.SLF-CLASS-2-NIC-AMOUNT.0">The amount in box [FSECL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SLF-CLASS-2-NIC-AMOUNT.0">The amount in box [FSECL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.SSE-BUSINESS-SALES-TURNOVER.1">As there is an entry in [SSE5] but [SSE6] is absent, the amount in box [SSE9] must be below ([£90,000] x number of days / (365 or 366) ) where number of days equals the number of days from [SSE5]  to [5 April 2025] inclusive. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SSE-BUSINESS-SALES-TURNOVER.1">As there is an entry in [SSE5] but [SSE6] is absent, the amount in box [SSE9] must be below ([£90,000] x number of days / (365 or 366) ) where number of days equals the number of days from [SSE5]  to [5 April 2025] inclusive. Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.SSE-BUSINESS-SALES-TURNOVER.2">6237</sch:diagnostic>
    <sch:diagnostic id="transactional.SSE-BUSINESS-SALES-TURNOVER.2">As there is an entry in [SSE6] but [SSE5] is absent, the amount in box [SSE9] must be below ( [£90,000] x number of days / (365 or 366) ) where number of days equals the number of days from [6 April 2024] to [SSE6] inclusive. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SSE-BUSINESS-SALES-TURNOVER.2">As there is an entry in [SSE6] but [SSE5] is absent, the amount in box [SSE9] must be below ( [£90,000] x number of days / (365 or 366) ) where number of days equals the number of days from [6 April 2024] to [SSE6] inclusive. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.SSE-CLASS-2-NIC-AMOUNT.0">The amount in box [SSECL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SSE-CLASS-2-NIC-AMOUNT.0">The amount in box [SSECL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.LUW-CLASS-2-NIC-AMOUNT.0">The amount in box [LUNCL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.LUW-CLASS-2-NIC-AMOUNT.0">The amount in box [LUNCL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.SA104F.0">The sum of ( [FPS41], [FPS44], [FPS48], [FPS55], and [FPS60] ) exceeds 0. Please complete box [FPS67]</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SA104F.0">The sum of ( [FPS41], [FPS44], [FPS48], [FPS55], and [FPS60] ) exceeds 0. Please complete box [FPS67]</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.PTR-CLASS-2-NIC-AMOUNT.0">The amount in box [FPSCL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.PTR-CLASS-2-NIC-AMOUNT.0">The amount in box [FPSCL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.PTR-TOTAL-UNTAXED-INCOME.0">The amount in box [FPS67] must equal ( [FPS41] + [FPS44] + [FPS48] + [FPS55] + [FPS60] ) Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.PTR-TOTAL-UNTAXED-INCOME.0">The amount in box [FPS67] must equal ( [FPS41] + [FPS44] + [FPS48] + [FPS55] + [FPS60] ) Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.SPS-CLASS-2-NIC-AMOUNT.0">The amount in box [SPSCL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SPS-CLASS-2-NIC-AMOUNT.0">The amount in box [SPSCL2] exceeds [£217.30]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.SA105.6">Total of all instances of ( [PRO5] and [PRO11] where both (UKL-LET-TRAD-ACCT] and [PRO18]) is absent in that instance ) plus the total of all instances of ( [PRO20], [PRO22], [PRO23] and [PRO31] ) must not exceed [£150,000] if [PRO20.2] is absent.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SA105.6">Total of all instances of ( [PRO5] and [PRO11] where both (UKL-LET-TRAD-ACCT] and [PRO18]) is absent in that instance ) plus the total of all instances of ( [PRO20], [PRO22], [PRO23] and [PRO31] ) must not exceed [£150,000] if [PRO20.2] is absent.</sch:diagnostic>
    <sch:diagnostic id="errorCode.SA105.0">8262</sch:diagnostic>
    <sch:diagnostic id="transactional.SA105.0">[PRO38] must be present if ( ( The sum of [PRO20], [PRO22], [PRO23], [PRO30], and [PRO31] ) minus ( The sum of [PRO20.1], [PRO24], [PRO25], [PRO26], [PRO27], [PRO28], [PRO29], [PRO32], [PRO33], [PRO33.1], [PRO33.2], [PRO34], [PRO34.1], [PRO35], [PRO36], and [PRO37] ) ) exceeds 0</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SA105.0">[PRO38] must be present if ( ( The sum of [PRO20], [PRO22], [PRO23], [PRO30], and [PRO31] ) minus ( The sum of [PRO20.1], [PRO24], [PRO25], [PRO26], [PRO27], [PRO28], [PRO29], [PRO32], [PRO33], [PRO33.1], [PRO33.2], [PRO34], [PRO34.1], [PRO35], [PRO36], and [PRO37] ) ) exceeds 0</sch:diagnostic>
    <sch:diagnostic id="errorCode.SA105.1">8263</sch:diagnostic>
    <sch:diagnostic id="transactional.SA105.1">[PRO41] must be present if ( ( The sum of [PRO24], [PRO25], [PRO26], [PRO27], [PRO28], [PRO29], [PRO32], [PRO33], [PRO33.1], [PRO33.2], [PRO34], [PRO34.1], [PRO35], [PRO36], and [PRO37] ) minus ( The sum of [PRO20], [PRO22], [PRO23], [PRO30], and [PRO31] ) ) exceeds 0</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SA105.1">[PRO41] must be present if ( ( The sum of [PRO24], [PRO25], [PRO26], [PRO27], [PRO28], [PRO29], [PRO32], [PRO33], [PRO33.1], [PRO33.2], [PRO34], [PRO34.1], [PRO35], [PRO36], and [PRO37] ) minus ( The sum of [PRO20], [PRO22], [PRO23], [PRO30], and [PRO31] ) ) exceeds 0</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PRO-HOLIDAY-LETTINGS.0">6117</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PRO-HOLIDAY-LETTINGS.0">The sum of ([PRO5] + [PRO10] + [PRO11]) minus the sum of ([PRO5.1] + [PRO6] + [PRO7] +  [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12]) is more than zero. Please complete box [PRO13].</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PRO-HOLIDAY-LETTINGS.0">The sum of ([PRO5] + [PRO10] + [PRO11]) minus the sum of ([PRO5.1] + [PRO6] + [PRO7] +  [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12]) is more than zero. Please complete box [PRO13].</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-PRO-HOLIDAY-LETTINGS.4">The sum of ( ( [PRO6], [PRO7], [PRO8], [PRO9], [PRO11.1], [PRO11.2] and [PRO12] ) minus ( [PRO5], [PRO10], and [PRO11] ) ) exceeds 0. Please complete box [PRO16].</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PRO-HOLIDAY-LETTINGS.4">The sum of ( ( [PRO6], [PRO7], [PRO8], [PRO9], [PRO11.1], [PRO11.2] and [PRO12] ) minus ( [PRO5], [PRO10], and [PRO11] ) ) exceeds 0. Please complete box [PRO16].</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PRO-HOLIDAY-LETTINGS.5">8507</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PRO-HOLIDAY-LETTINGS.5">If there is an occurrence of [PRO5-19] without [PRO18], and any box in [SA105] after the end of [PRO5-19] has been submitted, then [PRO20.2] and the [PRO5.2] from that occurrence must either both be submitted or both be absent.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PRO-HOLIDAY-LETTINGS.5">If there is an occurrence of [PRO5-19] without [PRO18], and any box in [SA105] after the end of [PRO5-19] has been submitted, then [PRO20.2] and the [PRO5.2] from that occurrence must either both be submitted or both be absent.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-FURNISHED-LETS-EXPS-AMO.0">The entry in box [PRO6] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-FURNISHED-LETS-EXPS-AMO.0">The entry in box [PRO6] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-LETTINGS-FINANCE-CHARGES.0">8511</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-LETTINGS-FINANCE-CHARGES.0">The entry in box [PRO7] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-LETTINGS-FINANCE-CHARGES.0">The entry in box [PRO7] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-LETTINGS-LEGAL-CHARGES.0">8512</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-LETTINGS-LEGAL-CHARGES.0">The entry in box [PRO8] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-LETTINGS-LEGAL-CHARGES.0">The entry in box [PRO8] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-LETTINGS-OTHER-DEDUCTIONS.0">8513</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-LETTINGS-OTHER-DEDUCTIONS.0">The entry in box [PRO9] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-LETTINGS-OTHER-DEDUCTIONS.0">The entry in box [PRO9] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-LETTINGS-PRIVATE-USE-ADJ.0">The entry in box [PRO10] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-LETTINGS-PRIVATE-USE-ADJ.0">The entry in box [PRO10] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-ECP-ALLCE.0">8593</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-ECP-ALLCE.0">The entry in box [PRO11.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-ECP-ALLCE.0">The entry in box [PRO11.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-ZERO-EMISSION-CAR-ALLCE.0">8589</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-ZERO-EMISSION-CAR-ALLCE.0">The entry in box [PRO11.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-ZERO-EMISSION-CAR-ALLCE.0">The entry in box [PRO11.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-LETTINGS-CAPITAL-ALLCE.0">8515</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-LETTINGS-CAPITAL-ALLCE.0">The entry in box [PRO12] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-LETTINGS-CAPITAL-ALLCE.0">The entry in box [PRO12] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-FURNISHED-LETS-PROFIT-AMT.1">8267</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-FURNISHED-LETS-PROFIT-AMT.1">The amount in box [PRO13] must equal the sum of [PRO5] + [PRO10] + [PRO11] minus sum of ([PRO5.1] + [PRO6] + [PRO7] + [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12]). Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-FURNISHED-LETS-PROFIT-AMT.1">The amount in box [PRO13] must equal the sum of [PRO5] + [PRO10] + [PRO11] minus sum of ([PRO5.1] + [PRO6] + [PRO7] + [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12]). Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-PRO-HOLIDAY-LETTINGS.1">The amount in box [PRO16] must equal the sum of [PRO6] + [PRO7] + [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12] minus ([PRO5] + [PRO10] + [PRO11]). Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PRO-HOLIDAY-LETTINGS.1">The amount in box [PRO16] must equal the sum of [PRO6] + [PRO7] + [PRO8] + [PRO9] + [PRO11.1] + [PRO11.2] + [PRO12] minus ([PRO5] + [PRO10] + [PRO11]). Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-FURNISHED-LETS-LOSS-AMT.1">8516</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-FURNISHED-LETS-LOSS-AMT.1">The entry in box [PRO16] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-FURNISHED-LETS-LOSS-AMT.1">The entry in box [PRO16] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-PPTY-RENT-RATES.0">The entry in box [PRO24] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-RENT-RATES.0">The entry in box [PRO24] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-REPAIRS-RENEWALS.0">8519</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-REPAIRS-RENEWALS.0">The entry in box [PRO25] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-REPAIRS-RENEWALS.0">The entry in box [PRO25] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-FINANCE-CHARGES.0">8520</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-FINANCE-CHARGES.0">The entry in box [PRO26] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-FINANCE-CHARGES.0">The entry in box [PRO26] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-LEGAL-CHARGES.0">8521</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-LEGAL-CHARGES.0">The entry in box [PRO27] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-LEGAL-CHARGES.0">The entry in box [PRO27] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-SERVICE-COSTS.0">8522</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-SERVICE-COSTS.0">The entry in box [PRO28] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-SERVICE-COSTS.0">The entry in box [PRO28] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-OTHER-DEDUCTIONS.0">8523</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-OTHER-DEDUCTIONS.0">The entry in box [PRO29] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-OTHER-DEDUCTIONS.0">The entry in box [PRO29] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-PRIVATE-USE-ADJUST.0">8524</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-PRIVATE-USE-ADJUST.0">The entry in box [PRO30] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-PRIVATE-USE-ADJUST.0">The entry in box [PRO30] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-PPTY-CAPITAL-ALLOWANCES.1">The entry in box [PRO32] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-CAPITAL-ALLOWANCES.1">The entry in box [PRO32] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-PPTY-SB-ALLCE.0">The entry in box [PRO33] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-SB-ALLCE.0">The entry in box [PRO33] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-ECP-ALLCE.0">8595</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-ECP-ALLCE.0">The entry in box [PRO33.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-ECP-ALLCE.0">The entry in box [PRO33.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-FREEPORT-SB-ALLCE.0">8530</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-FREEPORT-SB-ALLCE.0">The entry in box [PRO33.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-FREEPORT-SB-ALLCE.0">The entry in box [PRO33.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-ZERO-EMISSION-GV-ALLCE.0">8527</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-ZERO-EMISSION-GV-ALLCE.0">The entry in box [PRO34] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-ZERO-EMISSION-GV-ALLCE.0">The entry in box [PRO34] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-P-ZERO-EMISSION-CAR-ALLCE.0">8559</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-P-ZERO-EMISSION-CAR-ALLCE.0">The entry in box [PRO34.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-P-ZERO-EMISSION-CAR-ALLCE.0">The entry in box [PRO34.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-ENH-CAPITAL-ALLCES-AMT.0">8528</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-ENH-CAPITAL-ALLCES-AMT.0">The entry in box [PRO35] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-ENH-CAPITAL-ALLCES-AMT.0">The entry in box [PRO35] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-WEAR-AND-TEAR.0">8529</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-WEAR-AND-TEAR.0">The entry in box [PRO36] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-WEAR-AND-TEAR.0">The entry in box [PRO36] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-ADJUSTED-PROFIT-4-YEAR-AMT.0">The amount in box [PRO38] must equal ( the sum of [PRO20], [PRO22], [PRO23], [PRO30] and [PRO31] ) minus ( the sum of [PRO20.1], [PRO24], [PRO25], [PRO26], [PRO27], [PRO28], [PRO29], [PRO32], [PRO33], [PRO33.1], [PRO33.2], [PRO34], [PRO34.1], [PRO35], [PRO36] and [PRO37] ). Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-ADJUSTED-LOSS-AMT.1">[PRO41] is present so the following should be true: [PRO41] equals ( ( The sum of [PRO24], [PRO25], [PRO26], [PRO27], [PRO28], [PRO29], [PRO32], [PRO33], [PRO33.1], [PRO33.2], [PRO34], [PRO34.1], [PRO35], [PRO36], and [PRO37] ) minus ( The sum of [PRO20], [PRO22], [PRO23], [PRO30], and [PRO31] ) )</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UKL-PPTY-RES-FIN-COSTS.2">The entry in box [PRO44] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-RES-FIN-COSTS.2">The entry in box [PRO44] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.UKL-PPTY-RES-FIN-COSTS-BF.0">8596</sch:diagnostic>
    <sch:diagnostic id="transactional.UKL-PPTY-RES-FIN-COSTS-BF.0">The entry in box [PRO45] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UKL-PPTY-RES-FIN-COSTS-BF.0">The entry in box [PRO45] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="errorCode.FIG-REMITTED-FORG-SAVINGS.0">6475</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-REMITTED-FORG-SAVINGS.0">[FOR7.2F (pseudo)] must be equal to [FOR7.2B] if [FOR7.2E] is present</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-REMITTED-FORG-SAVINGS.0">[FOR7.2F (pseudo)] must be equal to [FOR7.2B] if [FOR7.2E] is present</sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-REMITTED-FORG-SAVINGS.1">6476</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-REMITTED-FORG-SAVINGS.1">[FOR7.2F (pseudo)] must be equal to [FOR7.2B] - [FOR7.2C] if [FOR7.2E] is absent</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-REMITTED-FORG-SAVINGS.1">[FOR7.2F (pseudo)] must be equal to [FOR7.2B] - [FOR7.2C] if [FOR7.2E] is absent</sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-REM-SAV-GROSS-AMT.1">6477</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-REM-SAV-GROSS-AMT.1">There is an entry in box [FOR7.2B]. Please complete box [FOR7.2F (pseudo)].</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-REM-SAV-GROSS-AMT.1">There is an entry in box [FOR7.2B]. Please complete box [FOR7.2F (pseudo)].</sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-REM-SAV-FOREIGN-TAX-AMT.1">6478</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-REM-SAV-FOREIGN-TAX-AMT.1">The amount in box [FOR7.2C] exceeds the amount in box [FOR7.2B]. Please check. </sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-REM-SAV-FOREIGN-TAX-AMT.1">The amount in box [FOR7.2C] exceeds the amount in box [FOR7.2B]. Please check. </sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-REM-SAV-TAX-ITEM-AMT.1">6479</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-REM-SAV-TAX-ITEM-AMT.1">The amount in box [FOR7.2D (pseudo)] exceeds the amount in box [FOR7.2B]. Please check. </sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-REM-SAV-TAX-ITEM-AMT.1">The amount in box [FOR7.2D (pseudo)] exceeds the amount in box [FOR7.2B]. Please check. </sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-REM-SAV-TAX-ITEM-AMT.2">6480</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-REM-SAV-TAX-ITEM-AMT.2">There is an entry in box [FOR7.2D (pseudo)]. Please complete box [FOR7.1].</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-REM-SAV-TAX-ITEM-AMT.2">There is an entry in box [FOR7.2D (pseudo)]. Please complete box [FOR7.1].</sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-REM-SAV-UK-CHARGEABLE-AMO.1">6481</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-REM-SAV-UK-CHARGEABLE-AMO.1">There is an entry in box [FOR7.2F (pseudo)]. Please complete box [FOR7.2].</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-REM-SAV-UK-CHARGEABLE-AMO.1">There is an entry in box [FOR7.2F (pseudo)]. Please complete box [FOR7.2].</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG4-PROPERTY-TOTAL-EXP-AMO.0">The entry in box [FOR17] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG4-PROPERTY-TOTAL-EXP-AMO.0">The entry in box [FOR17] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG4-PPTY-ADJUST-PERSNL-AMO.0">The entry in box [FOR19] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG4-PPTY-ADJUST-PERSNL-AMO.0">The entry in box [FOR19] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG4-PROPERTY-CAP-AMO.0">The entry in box [FOR21] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG4-PROPERTY-CAP-AMO.0">The entry in box [FOR21] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG-ZERO-EMISSION-CAR-ALLCE.0">The entry in box [FOR21.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-ZERO-EMISSION-CAR-ALLCE.0">The entry in box [FOR21.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG-ZERO-EMISSION-GV-ALLCE.0">The entry in box [FOR22] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-ZERO-EMISSION-GV-ALLCE.0">The entry in box [FOR22] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-SB-ALLCE.0">8597</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-SB-ALLCE.0">The entry in box [FOR22.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-SB-ALLCE.0">The entry in box [FOR22.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG-ECP-ALLCE.0">The entry in box [FOR22.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-ECP-ALLCE.0">The entry in box [FOR22.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG4-PROPERTY-WEAR-TEAR-AMO.0">The entry in box [FOR23] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG4-PROPERTY-WEAR-TEAR-AMO.0">The entry in box [FOR23] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.FIG-PPTY-ADJUSTD-PROF-LOSS-AMT.0">[FOR24] is valid only if this equals ( ( The sum of [FOR18], [FOR19], and [FOR20] ) minus ( The sum of [FOR14.1], [FOR21], [FOR21.1], [FOR22], [FOR22.1], [FOR22.2], and [FOR23] ) )</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-PPTY-ADJUSTD-PROF-LOSS-AMT.0">[FOR24] is valid only if this equals ( ( The sum of [FOR18], [FOR19], and [FOR20] ) minus ( The sum of [FOR14.1], [FOR21], [FOR21.1], [FOR22], [FOR22.1], [FOR22.2], and [FOR23] ) )</sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-PPTY-RES-FIN-COSTS.2">8547</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-PPTY-RES-FIN-COSTS.2">The entry in box [FOR24.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-PPTY-RES-FIN-COSTS.2">The entry in box [FOR24.1] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic id="errorCode.FIG-LET-PPTY-RES-FIN-COSTS-BF.0">8601</sch:diagnostic>
    <sch:diagnostic id="transactional.FIG-LET-PPTY-RES-FIN-COSTS-BF.0">The entry in box [FOR24.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FIG-LET-PPTY-RES-FIN-COSTS-BF.0">The entry in box [FOR24.2] should not be present as there is an entry in [PRO5.1] or [PRO20.1] or [FOR14.1] Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.RIM-CGT-PROPERTY-RES.1">[CGT3-13B] must not be empty.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.RIM-CGT-PROPERTY-RES.1">[CGT3-13B] must not be empty.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.CAP-INVESTORS-RELIEF-AMT.0">The amount in [CGT49] exceeds [£10,000,000]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.CAP-INVESTORS-RELIEF-AMT.0">The amount in [CGT49] exceeds [£10,000,000]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="errorCode.SA109.1">8573</sch:diagnostic>
    <sch:diagnostic id="transactional.SA109.1">[NRD29] must be present if at least one of [NRD23.1] and [NRD23.2] are present and [NRD28] is present.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SA109.1">[NRD29] must be present if at least one of [NRD23.1] and [NRD23.2] are present and [NRD28] is present.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.UK-DOM-PREVIOUS-REMITTANCE.0">If [NRD30] is present then [NRD28] must not be present unless [NRD29] is present.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UK-DOM-PREVIOUS-REMITTANCE.0">If [NRD30] is present then [NRD28] must not be present unless [NRD29] is present.</sch:diagnostic>
    ...
    <sch:diagnostic id="errorCode.DOM-QAHC-DEEMED-SIG.0">8605</sch:diagnostic>
    <sch:diagnostic id="transactional.DOM-QAHC-DEEMED-SIG.0">[NRD39.1] is present so [NRD28] must be is present</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.DOM-QAHC-DEEMED-SIG.0">[NRD39.1] is present so [NRD28] must be is present</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.ITF-SELF-CALC-CLASS2-NIC-TOTAL.0">The amount in box [CAL4.1] exceeds [£217.30]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.ITF-SELF-CALC-CLASS2-NIC-TOTAL.0">The amount in box [CAL4.1] exceeds [£217.30]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.ITF4-MCA-AMOUNT.0">The amount in box [CAL13] exceeds [£11,080] for the year. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.ITF4-MCA-AMOUNT.0">The amount in box [CAL13] exceeds [£11,080] for the year. Please check.</sch:diagnostic>
